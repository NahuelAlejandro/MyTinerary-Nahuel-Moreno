...
export const Hero = () => {
  return (
    <section className="relative w-full h-[400px] lg:h-[700px] flex flex-col overflow-hidden  items-center">
        ...
        <a className=' absolute bottom-16 px-2 py-1 bg-sky-600 hover:bg-sky-400 hover:scale-110 hover:animate-none text-white rounded-md border border-black md:bottom-4 lg:bottom-10 motion-safe:animate-bounce lg:text-xl' href=""> Choose your city</a>
