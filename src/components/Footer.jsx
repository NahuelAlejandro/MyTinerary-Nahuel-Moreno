        ...
        <footer className="bg-black flex flex-col items-center text-white justify-around px-4 w-full gap-4 py-4 md:flex-row md:items-start">
            ...
            <section className=" flex flex-col items-center gap-3 md:gap-5">
                ...
                <ul className="flex flex-col gap-2 lg:text-lg">
                    <li><a className="hover:text-sky-300 py-1 hover:border-b-[1px] border-sky-400" href="#">Privacy</a></li>
                    <li><a className="hover:text-sky-300 py-1 hover:border-b-[1px] border-sky-400" href="#">Terms of use</a></li>
                    <li><a className="hover:text-sky-300 py-1 hover:border-b-[1px] border-sky-400" href="#">Vrbo terms and conditions</a></li>
                    <li><a className="hover:text-sky-300 py-1 hover:border-b-[1px] border-sky-400" href="#">Accessibility</a></li>
                </ul>
            </section>
            <section className=" flex flex-col items-center gap-3 md:gap-5">
