...
const CitiesCards = ({city}) => {
  ...
  return (
            <article className='w-full h-48 relative overflow-hidden rounded cursor-pointer md:h-80 md:w-[30%] lg:h-96 duration-500 transition-all group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100' id={city._id} onClick={handleClick}>
